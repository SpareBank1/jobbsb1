...
const Header = ({ siteTitle, opening }) => (
  ...
  {/* <Location>
    {({ location }) => {
      ...
      <Link to="/" className="sb1-header__link">
        <svg viewBox="0 0 182 40" height="40" xmlns="http://www.w3.org/2000/svg" className="sb1-header__logo">
            <title>
              {siteTitle}
            </title>
        ...
        {/* <svg viewBox="7 7 88 88" height="40" xmlns="http://www.w3.org/2000/svg" className="sb1-header__logo">
          <title>
            {siteTitle}
          </title>
          <g>
            <path d="M51.1 8.7c-4.5 0-8.8.7-12.8 2 17-3.7 33.9 3.3 40 17.7 7.1 16.6-3 36.8-22.5 45.1-17.5 7.4-36.6 2.6-45.4-10.4 5.2 17.6 21.4 30.4 40.7 30.4 23.4 0 42.4-19 42.4-42.4S74.5 8.7 51.1 8.7z" fill="#e60000"/>
            <path d="M55.8 73.5C75.3 65.2 85.4 45 78.3 28.4 72.2 14 55.3 7 38.3 10.7 21.1 16.1 8.7 32.2 8.7 51.1c0 4.2.6 8.2 1.7 12 8.8 13 27.9 17.8 45.4 10.4z" fill="#af0000"/>
            <path d="M62 70.3V26.7c0-.8-.7-1.5-1.6-1.5h-9.9c-.7 0-1.1.1-1.7.3l-12.7 6.6c-.8.3-1.1.8-1.1 1.6v7.1c0 .8.7 1.5 1.5 1.5h8.1v34.3c3.8-.6 7.5-1.6 11.2-3.1 2.2-1 4.2-2 6.2-3.2z" fill="#fff"/>
          </g>
        </svg> */}
      </Link>
