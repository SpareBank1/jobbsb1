  ...
  <Location>
    {({ location }) => {
      ...
      if (path === '/') {
        ...
        return <header className={classNames( 'sb1-header', { 'sb1-header--opening': opening })}>
                <BackButton element="a" href="/" className="sb1-header__link sb1-header__link--back">Tilbake</BackButton>
