...
const IndexPage = (props) => (
  <Layout>
    ...
    <SEO title="Her jobber vi" keywords={[`sparebank 1`, `utvikling`, `utviklere`]} />
    ...
    <div className="sb1-hero sb1-curved sb1-curved--grey-warm">
        <div className="sb1-hero__inner">
            <div className="sb1-hero__preamble">
                ...
                <p className="ffe-body-text">Dette er utviklerene i SpareBank 1 Utvikling, og på denne siden kan du bli bedre kjent med hvem vi er, hva vi gjør og hvordan vi jobber – gjennom oss som faktisk koder her.</p>
            </div>
        </div>
    </div>
