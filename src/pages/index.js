    ...
    <div className="sb1-hero sb1-curved sb1-curved--grey-warm">
        <div className="sb1-hero__inner">
            <div className="sb1-hero__preamble">
                ...
                <p className="ffe-body-text">Dette er SpareBank 1 Utvikling, og på denne siden kan du bli bedre kjent med hvem vi er, hva vi gjør og hvordan vi jobber – gjennom oss som faktisk jobber her. Så kan du vurdere selv om du også har lyst til å bli en del av det vi mener er det beste og triveligste IT-miljøet i bransjen. Med de flinkeste folka.</p>
        ...
        <GridRow reverse={true}>
            <GridCol sm={{ cols: 12 }} className="sb1-workplace">
                <div className="sb1-workplace__preamble">
                    <h3 className="ffe-h3">Vi skaper en enklere og bedre hverdagsøkonomi</h3>
                    ...
                    <InlineGrid>
                        <GridRow>
                            ...
                            <GridCol sm={{ cols: 12 }} md={{ cols: 6 }}>
                                <Link className="sb1-frontpage-link" to="/aws/">
                                    <h3 className="ffe-h4">Mobil- og nettbank i AWS</h3>
                                </Link>
                            </GridCol>
                            <GridCol sm={{ cols: 12 }} md={{ cols: 6 }}>
                                <Link className="sb1-frontpage-link" to="/bounty/">
                            ...
                            <GridCol sm={{ cols: 12 }} md={{ cols: 6 }}>
                                <Link className="sb1-frontpage-link" to="/smudtech-2023/">
